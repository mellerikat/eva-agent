...
Options:
  ...
  --chart-version <ver>             Helm chart version (default: 3.0.1)
...
Examples:
  ./install_eva_agent.sh --image 3.0.1
  ./install_eva_agent.sh --chart eva-agent/eva-agent --chart-version 3.0.1
USAGE
}
...
CHART_VERSION="${CHART_VERSION:-3.0.1}"
IMAGE_TAG="${IMAGE_TAG:-}"
